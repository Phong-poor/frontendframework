...
import danhgiasanpham from './components/danhgiasanpham.vue'
...
const routes = [
    ...
    { path: '/adminOrders', name: 'adminOrders', component: adminOrders, meta: { isAuth: false } },
    { path: '/danhgiasanpham', name: 'danhgiasanpham', component: danhgiasanpham, meta: { isAuth: false } },
