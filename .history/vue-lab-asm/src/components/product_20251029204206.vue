...
const uniqueCategories = computed(() => {
  ...
  return [...new Set(categories)]; // loại bỏ trùng
});
          ...
          <div class="d-flex justify-content-between align-items-center mb-3">
            <span class="fw-semibold fs-5">Danh sách sản phẩm</span>
              <div class="d-flex align-items-center gap-2">
                <select class="form-select" v-model="selectedCategory" style="width: 200px;">
                  <option value="">Tất cả danh mục</option>
                  <option v-for="categories in uniqueCategories" :key="categories" :value="categories">
                    {{ categories }}
                  </option>
                </select>
