    ...
    <div class="page-wrapper">
        ...
        <main class="container py-4" v-if="products">
                ...
                <div class="col-md-7 d-flex flex-column justify-content-center thongtin">
                    ...
                    <div class="group">
                        ...
                        <button 
                            v-else 
                            disabled 
                            class="btn btn-sm btn-success opacity-50 cursor-not-allowed"
                            >
                            Hết hàng
                        </button>
            ...
            <div class="mt-5">
                ...
                <div v-if="products.comments && products.comments.length > 0">
                    <div
                        v-for="(cmt, index) in products.comments"
                        :key="index"
                        class="border rounded p-3 mb-3 shadow-sm bg-light"
                        >
                        <strong>{{ cmt.username }}</strong>:
                        <span>{{ cmt.comment }}</span>
                        <div class="text-muted small">{{ cmt.date }}</div>
                    </div>
                </div>
                    ...
                    <div v-for="item in relatedProducts" :key="item.id" class="col-6 col-md-3">
                        <div class="card h-100 shadow-sm related-card">
                            ...
                            <div class="card-body d-flex flex-column justify-content-between">
                                ...
                                <router-link :to="/detailed-products/${item.id}`" class="btn btn-outline-primary btn-sm mt-auto">
                                Xem chi tiết
                                </router-link>
                            </div>
                        </div>
