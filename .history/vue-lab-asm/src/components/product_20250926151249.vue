          ...
          <div class="card-body">
            <form action="#" method="post" @submit.prevent="handleSubmit">
              ...
              <div class="mb-3">
                ...
                <input type="url" v-model="products.title" class="form-control" id="pImage" name="image" placeholder="https://example.com/image.jpg" required>
              </div>
              <div class="mb-3">
                <label for="pDesc" class="form-label">Description</label>
                <textarea id="pDesc" v-model="products.title" class="form-control" name="description" rows="3" placeholder="Short product description" required></textarea>
              </div>
