...
<template>
    ...
    <div>
        ...
        <input :value="message1" placeholder="Không thay đổi được" />
        <p>Giá trị: {{ message1 }}</p>

        <h3>Two-way Binding</h3>
        <input v-model="twoWayMessage" placeholder="Nhập gì đó..." />
        <p>Giá trị: {{ twoWayMessage }}</p>
    </div>
</template>
<style scoped>
form {
