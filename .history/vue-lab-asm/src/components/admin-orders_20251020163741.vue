...
async function updateStatus(id, newStatus) {
    try {
        ...
        // ✅ Cập nhật trên frontend sau khi API thành công
    ...
    <div class="page-wrapper">
        <header class="py-4 bg-white border-bottom mb-4">
          ...
          <main class="container pb-5">
                                        ...
                                        <tr v-for="order in orders" :key="order.id">
                                            ...
                                            <td class="text-end">
                                                <div class="btn-group" role="group">
                                                    ...
                                                    >
                                                    <i class="bi bi-truck"></i> Hoàn tất
                                                    </button>
                                                    ...
                                                    <!-- 📝 Đã hủy (nếu vẫn còn status này trong DB) -->
                                                    <button
            ...
            <router-link to="/adminCategory" class="btn btn-primary users">Danh mục</router-link>
