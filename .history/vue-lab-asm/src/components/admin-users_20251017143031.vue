                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tr v-for="item in users" :key="item.id">
                                ...
                                <td class="text-end">
                                    ...
                                    <a 
                                        v-if="!(item.id === 1 || item.username === 'admin' || item.id === JSON.parse(localStorage.getItem('currentUser'))?.id)" href="#deleteForm" @click="handleDelete(item.id)" class="btn btn-sm btn-outline-secondary">
                                        Delete
                                    </a>
                                </td>
                            </tr>
