          ...
          <div class="card shadow-sm sticky-col" id="editForm">
            ...
            <div class="card-body">
              <form action="#" method="post" @submit.prevent="handleSubmit">
                <div class="mb-3">
                  <label for="pTitle" class="form-label">Name</label>
                  <input type="text" v-model="product.name" class="form-control" id="pTitle" name="name" placeholder="Product title" required>
                </div>
                <div class="mb-3">
