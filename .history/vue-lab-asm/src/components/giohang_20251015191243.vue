                        ...
                        <tr v-for="item in cart" :key="item.id">
                            ...
                            <td>      
                              <div class="d-flex justify-content-center align-items-center">
                                <button class="btn btn-sm btn-outline-secondary" @click="giamSoLuong(item)">-</button>
                                ...
                                <button class="btn btn-sm btn-outline-secondary" @click="tangSoLuong(item)">+</button>
                              </div>
                            </td>
                            <td>{{ item.price }}</td>
