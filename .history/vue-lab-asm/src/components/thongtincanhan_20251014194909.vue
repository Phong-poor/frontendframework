        ...
        <main class="container pb-5">
            <div class="row g-4">
                ...
                <div class="card shadow-sm">
                    ...
                    <span class="fw-semibold">Thông tin người dùng</span>
                    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <thead class="table-light">
                            ...
                            <th style="width:150px" class="text-end">Ngày tạo</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            ...
                            <td class="text-end">{{ formatDate(user.created_at) }}</td>
                            </tr>

                            <tr v-if="users.length === 0">
                            <td colspan="6" class="text-center text-muted py-3">Không có người dùng</td>
                            </tr>
                        </tbody>
                        </table>
                    </div>
