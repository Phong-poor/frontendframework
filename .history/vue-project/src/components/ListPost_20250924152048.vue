  ...
  <main class="container py-4">
    ...
    <div class="list-group">
      ...
      <a href="#"
        ...
        <div class="row g-3 align-items-start">
          <div class="col-12 col-sm-auto">
            <img src="https://picsum.photos/300/200?random=2" alt="Post 2" class="post-thumb w-100 w-sm-auto" />
          </div>
          <div class="col">
            <div class="d-flex w-100 justify-content-between">
              <h2 class="h5 mb-1">Post Title Two</h2>
              <small class="text-muted">Sep 22, 2025</small>
            </div>
            <div class="mb-2">
              <small class="text-muted">by <strong>Jane</strong> · 3 min read</small>
            </div>
            <p class="post-excerpt mb-2">
              Cras mattis consectetur purus sit amet fermentum. Maecenas faucibus mollis interdum. Donec id elit non mi
              porta gravida at eget metus…
            </p>
            <div class="d-flex gap-2">
              <span class="badge text-bg-success">Updates</span>
            </div>
          </div>
        </div>
      </a>
      ...
      <a href="#"
        ...
        <div class="row g-3 align-items-start">
          <div class="col-12 col-sm-auto">
            <img src="https://picsum.photos/300/200?random=3" alt="Post 3" class="post-thumb w-100 w-sm-auto" />
          </div>
          <div class="col">
            <div class="d-flex w-100 justify-content-between">
              <h2 class="h5 mb-1">Post Title Three</h2>
              <small class="text-muted">Sep 18, 2025</small>
            </div>
            <div class="mb-2">
              <small class="text-muted">by <strong>Team</strong> · 7 min read</small>
            </div>
            <p class="post-excerpt mb-2">
            ...
            <div class="d-flex gap-2">
              <span class="badge text-bg-warning">Tips</span>
